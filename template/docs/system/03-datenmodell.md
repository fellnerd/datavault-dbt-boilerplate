...
| `dss_source_filename` | NVARCHAR | Dasselbe — ältere Schreibweise in den ISE-Objekten. Nicht umbenennen (Vault-Tabellen), aber nicht neu verwenden |
...
| Spalte | Typ | Beschreibung |
|--------|-----|--------------|
| `dss_sec_value_key` | NVARCHAR | RLS-Schlüssel als hierarchischer Pfad (`<mandant>\|\|<gruppe>\|\|<detail>`), nur auf den Träger-Dimensionen der Zeilenfilter. Siehe [docs/security/](../security/04-rls-dimensional.md) |
