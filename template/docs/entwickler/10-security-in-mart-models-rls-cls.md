...
> Kurzfassung für Modellentwickler. Vollständige Referenz: **[docs/security/](../security/README.md)**
> — insbesondere [Neues Objekt absichern](../security/06-neues-objekt-absichern.md).
...
[Verifizieren](../security/07-verifizieren.md). `EXECUTE AS` taugt dafür **nicht**.
