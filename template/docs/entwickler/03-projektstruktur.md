...
│   ├── entwickler/             #    Entwicklerhandbuch ← Diese Datei
│   ├── schulung/               #    Schulungsunterlagen
│   ├── <mandant>-architektur/        #    Mandantenspezifisch: Projektdoku, Business Case
│   ├── lessons-learned/        #    Entscheidungen, Fallstricke
│   ├── power-bi/               #    Report-Pläne, Measures
│   ├── erweiterungen/          #    Security, Performance
│   └── issues/                 #    Datierte Analysen
│
