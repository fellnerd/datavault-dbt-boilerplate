...
var HeadingPlaceholder = class extends AbstractPlaceholder {
  ...
  makeValue(path) {
    var _a4, _b2, _c, _d;
    const headings = (_a4 = this.factory(path, "headings")) != null ? _a4 : [];
    const match = this.placeholder.match(/^#h([1-6])$/);
    if (match) {
      const level = Number(match[1]);
      const found = headings.find((h3) => h3.level === level);
      return (_b2 = found == null ? void 0 : found.heading) != null ? _b2 : "";
    }
    return (_d = (_c = headings[0]) == null ? void 0 : _c.heading) != null ? _d : "";
  }
};
...
var FakeTitleElementService = class {
  ...
  getOrCreate({
    ...
    element = createEl(original.tagName.toLowerCase());
...
var ObsidianFacade = class {
  ...
  getActiveLeaf() {
    ...
    return (_c = (_b2 = (_a4 = workspace == null ? void 0 : workspace.getActiveViewOfType(import_obsidian19.View)) == null ? void 0 : _a4.leaf) != null ? _b2 : workspace == null ? void 0 : workspace.getMostRecentLeaf()) != null ? _c : null;
  }
  getActiveFile() {
    var _a4, _b2;
...
Loaded. Background: ${background}`);
  ...
  bind() {
    ...
    this.app.workspace.onLayoutReady(async () => {
      ...
      await new Promise((r3) => window.setTimeout(r3, 3e3));
      this.reloadFeatures();
      await this.mc.refresh();
