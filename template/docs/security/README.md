...
- **Endnutzer:** [Datenzugriff & Berechtigungen](../benutzer/12-datenzugriff-berechtigungen-security.md)
- **Modellentwickler (Kurzfassung):** [Security in Mart-Models](../entwickler/10-security-in-mart-models-rls-cls.md)
